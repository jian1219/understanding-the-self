    ...
    <div className="flex justify-center dashboard-background">
      <div className="dashboard-header">
        ...
        <div className="dashboard-nav">
          <button onClick={() => handleNavigation('/learningHome')}>
            Home
          </button>
          <button className="button-activate" onClick={() => handleNavigation('/learningStudents')}>Students</button>
